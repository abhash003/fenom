        ...
        public class ErrorCodeLookup
        {
            ...
            public static ErrorCode Lookup(int code)
            {
                ...
                try
                {
                    ...
                    var displayCode = ((code & 0xf0) << 4) | (code & 0x0f);
            ...
            protected static void InitErrorCodes()
            {
                _errorCodes = new Dictionary<int, string>
                {
                    ...
                    {0x32,  "Breath flow was too high. Focus on the star." },
                    {0x33,  "Breath flow was too low. Focus on the star." },
                    {0x34,  "Breath flow was unstable. Provide a steady and smooth flow." },
                    {0x35,  "Breath flow did not stop fast enough. Let go immediately at STOP." },
                    {0x36,  "Breath flow detected after STOP." },
                    {0x37,  "undecl: 0x37" },
                    {0x38,  "undecl: 0x38" },
                    {0x39,  "undecl: 0x39" },
                    {0x3A,  "undecl: 0x3A" },
