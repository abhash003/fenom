            ...
            if (Services.DeviceService.Current != null && Services.DeviceService.Current.IsNotConnectedRedirect())
            {
                ...
                switch (deviceStatus)
                {
                    ...
                    case DeviceCheckEnum.DevicePurging:
                        await Services.Dialogs.NotifyDevicePurgingAsync(Services.DeviceService.Current.DeviceReadyCountDown, StartStandardTestCommand);
                        break;
            ...
            if (Services.DeviceService.Current != null && Services.DeviceService.Current.IsNotConnectedRedirect())
            {
                switch (Services.DeviceService.Current.CheckDeviceBeforeTest())
                {
                    case DeviceCheckEnum.Ready:
                        ...
                        break;
                    case DeviceCheckEnum.DevicePurging:
                        await Services.Dialogs.NotifyDevicePurgingAsync(Services.DeviceService.Current.DeviceReadyCountDown, StartShortTestCommand);
                        break;
                    case DeviceCheckEnum.HumidityOutOfRange:
